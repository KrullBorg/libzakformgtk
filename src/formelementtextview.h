...
#ifndef __ZAK_FORM_GTK_FORM_ELEMENT_TEXTVIEW_H__
#define __ZAK_FORM_GTK_FORM_ELEMENT_TEXTVIEW_H__
...
typedef struct _ZakFormGtkFormElementTextview ZakFormGtkFormElementTextview;
typedef struct _ZakFormGtkFormElementTextviewClass ZakFormGtkFormElementTextviewClass;

struct _ZakFormGtkFormElementTextview
	{
		ZakFormGtkFormElement parent_instance;
	};

struct _ZakFormGtkFormElementTextviewClass
	{
		ZakFormGtkFormElementClass parent_class;
	};


GType zak_form_gtk_form_element_textview_get_type (void);
...
#endif /* __ZAK_FORM_GTK_FORM_ELEMENT_TEXTVIEW_H__ */
