...
#ifndef __ZAK_FORM_GTK_FORM_ELEMENT_LABEL_H__
#define __ZAK_FORM_GTK_FORM_ELEMENT_LABEL_H__
...
typedef struct _ZakFormGtkFormElementLabel ZakFormGtkFormElementLabel;
typedef struct _ZakFormGtkFormElementLabelClass ZakFormGtkFormElementLabelClass;

struct _ZakFormGtkFormElementLabel
	{
		ZakFormGtkFormElement parent_instance;
	};

struct _ZakFormGtkFormElementLabelClass
	{
		ZakFormGtkFormElementClass parent_class;
	};


GType zak_form_gtk_form_element_label_get_type (void);
...
#endif /* __ZAK_FORM_GTK_FORM_ELEMENT_LABEL_H__ */
